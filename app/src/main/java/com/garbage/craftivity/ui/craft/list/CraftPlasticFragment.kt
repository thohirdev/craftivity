...
import com.garbage.craftivity.databinding.FragmentCraftPlasticBinding
...
class CraftPlasticFragment : Fragment(), CraftAdapter.FragmentCallback {

    private lateinit var binding: FragmentCraftPlasticBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCraftPlasticBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun showCraft() {
        val craft = viewModel.getCraftPlastic()
