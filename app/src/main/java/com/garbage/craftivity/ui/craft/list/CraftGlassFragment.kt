...
import com.garbage.craftivity.databinding.FragmentCraftGlassBinding
...
class CraftGlassFragment : Fragment(), CraftAdapter.FragmentCallback {

    private lateinit var binding: FragmentCraftGlassBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCraftGlassBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun showCraft() {
        val craft = viewModel.getCraftGlass()
