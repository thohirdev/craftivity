...
import com.garbage.craftivity.databinding.FragmentCraftCardboardBinding
...
class CraftCardboardFragment : Fragment(), CraftAdapter.FragmentCallback {

    private lateinit var binding: FragmentCraftCardboardBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCraftCardboardBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun showCraft() {
        val craft = viewModel.getCraftCardboard()
