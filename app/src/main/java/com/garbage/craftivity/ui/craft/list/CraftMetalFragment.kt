...
import com.garbage.craftivity.databinding.FragmentCraftMetalBinding
...
class CraftMetalFragment : Fragment(), CraftAdapter.FragmentCallback {

    private lateinit var binding: FragmentCraftMetalBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCraftMetalBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun showCraft() {
        val craft = viewModel.getCraftMetal()
